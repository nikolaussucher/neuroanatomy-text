...
```{r nmdar, fig.cap='(ref:nmda)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/synapse/NMDA_receptor.png")
```
...
```{r achr, fig.cap='(ref:ach)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/synapse/nAch_receptor.png")
```
