...
(ref:ventricle) The ventricular system of the brain as seen from above. [Textbook of anatomy. Section 2. The muscular system: the nervous system: the organs of sense and integument edited by D. J. Cunningham](https://wellcomelibrary.org/item/b21271070) 

```{r ventricles, fig.cap='(ref:ventricle)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/cns/Ventricles.jpg")
```
