...
\begin{center}\includegraphics[width=0.7\linewidth]{Brain_case} \end{center}
...
\hypertarget{comparative-anatomy-and-evolution}{%
\section{Comparative anatomy and evolution}\label{comparative-anatomy-and-evolution}}

\hypertarget{neural-precursors-in-porifera}{%
\subsection{Neural precursors in porifera}\label{neural-precursors-in-porifera}}
...
\hypertarget{radiata}{%
\subsection{Radiata}\label{radiata}}
...
\hypertarget{bilateria}{%
\subsection{Bilateria}\label{bilateria}}
...
\hypertarget{activity-dependent-mechanisms-in-the-assembly-of-neural-circuitsedit}{%
\section{Activity dependent mechanisms in the assembly of neural circuits{[}edit{]}}\label{activity-dependent-mechanisms-in-the-assembly-of-neural-circuitsedit}}
...
E\_eq,K\textsuperscript{+}\_ is the equilibrium potential for potassium, measured in volts
...
{[}K\textsuperscript{+}{]}\emph{o} is the extracellular concentration of potassium, measured in mol·m\textsuperscript{−3} or mmol·l\textsuperscript{−1}
{[}K\textsuperscript{+}{]}i is the intracellular concentration of potassium
...
As can be derived from the Goldman equation shown above, the effect of increasing the permeability of a membrane to a particular type of ion shifts the membrane potential toward the reversal potential for that ion. Thus, opening Na+ channels shifts the membrane potential toward the Na+ reversal potential, which is usually around +100 mV. Likewise, opening K\textsuperscript{+} channels shifts the membrane potential toward about --90 mV, and opening Cl\textsuperscript{−} channels shifts it toward about --70 mV (resting potential of most membranes). Thus, Na+ channels shift the membrane potential in a positive direction, K\textsuperscript{+} channels shift it in a negative direction (except when the membrane is hyperpolarized to a value more negative than the K\textsuperscript{+} reversal potential), and Cl\textsuperscript{−} channels tend to shift it towards the resting potential.
...
Synaptic Potential Mechanism{[}edit{]}
...
\section{The Brain}\label{the-brain}}
...
The cerebral cortex is generally classified into four lobes: the frontal, parietal, occipital and temporal lobes. The lobes are classified based on their overlying neurocranial bones.
...
\hypertarget{cerebellum-1}{%
\subsection{Cerebellum}\label{cerebellum-1}}
...
\section{Organ of Corti}\label{organ-of-corti}}
...
\hypertarget{primary-auditory-cortex}{%
\section{Primary auditory cortex}\label{primary-auditory-cortex}}
...
The superior or anterior semicircular canal is a part of the vestibular system and detects rotations of the head in around the lateral axis, or in other words rotation in the sagittal plane. This occurs, for example, when nodding your head.
...
The posterior semicircular canal is a part of the vestibular system that detects rotation of the head around the antero-posterior (sagittal) axis, or in other words rotation in the coronal plane. This occurs, for example, when you move your head to touch your shoulders, or when doing a cartwheel.
...
Development
Findings from a 2009 study demonstrated a critical late role for BMP 2b in the morphogenesis of semicircular canals in the zebrafish inner ear. It is suspected that the role of bmp2 in semicircular canal duct outgrowth is likely to be conserved between different vertebrate species.
...
Cochlea and vestibular system
See also: Balance (ability) and Equilibrioception
...
\hypertarget{the-visual-system-1}{%
\section{The Visual System}\label{the-visual-system-1}}
...
\section{The Basal Ganglia}\label{the-basal-ganglia}}
