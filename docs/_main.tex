...
{\centering \includegraphics[width=0.7\linewidth]{./figures/nervoussystem/astrocytes} 

}

\caption{Glial cells from the cerebral cortex. Because of their star-like shape, this type of glial cells are called astrocytes.}\label{fig:astrocyte}
\end{figure}
...
Glial cells from the cerebral cortex. Because of their star-like shape, this type of glial cells are called astrocytes. Astrocytes in the grey matter of the cerebral cortex with their endfeet on brain capillaries.
...
\caption{Glial cells from the cerebral cortex. Because of their star-like shape, this type of glial cells are called astrocytes.}\label{fig:astrobbb}
\end{figure}
