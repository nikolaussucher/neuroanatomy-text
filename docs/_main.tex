...
\begin{longtable}[t]{>{\raggedright\arraybackslash}p{10em}>{\raggedright\arraybackslash}p{20em}>{\raggedright\arraybackslash}p{10em}>{\raggedright\arraybackslash}p{20em}}
...
\hypertarget{corticospinal-tract-1}{%
\subsection{Corticospinal tract}\label{corticospinal-tract-1}}
...
\hypertarget{corticobulbar-tract-1}{%
\subsection{Corticobulbar tract}\label{corticobulbar-tract-1}}
