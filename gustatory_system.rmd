...
knitr::include_graphics("./figures/gustatory/CunninghamSection2Page770.jpg")
```
...
(ref:buds) A. Three quarter surface view of a taste bud from the papilla foliata of a rabbit (highly mgnified). B. Vertical section of taste bud from the papilla foliata of a rabbit (highly mgnified). From [Textbook of anatomy. Section 2. The muscular system: the nervous system: the organs of sense and integument edited by D. J. Cunningham](https://wellcomelibrary.org/item/b21271070) 

```{r tastebuds, fig.cap='(ref:buds)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/gustatory/CunninghamSection2Page771.jpg")
```
...
knitr::include_graphics("./figures/gustatory/CunninghamSection2Page771Cells.jpg")
```
