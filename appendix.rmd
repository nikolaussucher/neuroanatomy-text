...
knitr::kable(comparison, col.names = c("Axis","Directional term","Directed towards"), digits = 2, align = 'lll', longtable = TRUE, booktabs = TRUE, caption = "The main anatomical axes.") %>% kable_styling(latex_options = c("striped", "scale_down", "hold_position")) %>% column_spec(1, width = "30em") %>% column_spec(2, width = "10em") %>% column_spec(3, width = "10em") %>% collapse_rows(columns = 1:2, latex_hline = "major", valign = "middle") 
```
