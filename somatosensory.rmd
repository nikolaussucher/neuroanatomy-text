...
knitr::include_graphics("./figures/somatosensory/Gray940.png")
```
...
knitr::include_graphics("./figures/somatosensory/mechano_sensitive_channel.png")
```
...
knitr::include_graphics("./figures/somatosensory/TouchReceptors.jpg")
```
...
knitr::include_graphics("./figures/somatosensory/TRPV1.png")
```
...
knitr::include_graphics("./figures/somatosensory/CajalMuscleSpindle.jpg")
```
...
knitr::include_graphics("./figures/somatosensory/CajalGolgiTendon.jpg")
```
