...
\usepackage{enumitem} % provides lists beyond 3 levels
\setlistdepth{9} % set lists to 9 levels
...
\hypersetup{unicode=true,
            pdftitle={A Text For BIO400\\Neuroanatomy at Salem State University},
...
\setlength{\droptitle}{-2em}
  \title{A Text For BIO400
  \\ Neuroanatomy at Salem State University}
