...
(ref:hns) [Diagram of the the human peripheral nervous system (blue) and central nervous system (yellow).](https://commons.wikimedia.org/wiki/File:Nervous_system_diagram-en.svg)
 

```{r pnscns, fig.cap='(ref:hns)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/pns/Nervous_system_diagram-en.svg")
```
...
The Graeco-Roman anatomist [Galen](https://en.wikipedia.org/wiki/Galen) (AD 129–210) named seven pairs of cranial nerves. Much later, in 1664, English anatomist [Thomas Willis](https://en.wikipedia.org/wiki/Thomas_Willis) suggested that there were actually 9 pairs of nerves. Finally, in 1778, German anatomist [Samuel Soemmering](https://en.wikipedia.org/wiki/Samuel_Thomas_von_Sömmerring) named the 12 pairs of nerves that are generally accepted today. 
...
(ref:cn) View of the base of the brain. The cranial nerves are colored in purple and labeled with numbers on the left (1 to 12). From [Gray Henry, Anatomy of the Human Body. 20^th^ Edition, Lea & Febiger, Philadelphia & New York, 1918](https://archive.org/details/anatomyofhumanbo1918gray/page/n6/mode/2up) 
 

```{r baseofbrain, fig.cap='(ref:cn)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/pns/GrayAnat1918p817.jpg")
```
...
(ref:autonomic) Diagram of the sympathetic and parasympathetic divisions of the autonomic nervous system. Blue, cranial and sacral branches of the parasympathetic division. Red, the sympathetic division; broken lines(----), postganglionic fibers to spinal and cranial nerves to supply vasomotors to head, trunk and limbs, motor fibers to smooth muscles of skin and fibers to sweat glands. From [Gray Henry, Anatomy of the Human Body. 20^th^ Edition, Lea & Febiger, Philadelphia & New York, 1918](https://archive.org/details/anatomyofhumanbo1918gray/page/n6/mode/2up) 

```{r autonomicdiagram, fig.cap='(ref:autonomic)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/pns/GrayAnat1918p971.jpg")
```
...
(ref:symp) [Innvervations of the sympathetic nervous system.](https://commons.wikimedia.org/wiki/File:1501_Connections_of_the_Sympathetic_Nervous_System.jpg)
 

```{r sns, fig.cap='(ref:symp)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/pns/1501_Connections_of_the_Sympathetic_Nervous_System.jpg")
```


The name of this system can be traced to the concept of sympathy, in the sense of "connection between parts", first used medically by Galen. In the 18th century, [Jacob B. Winslow](https://en.wikipedia.org/wiki/Jacob_B._Winslow) applied the term specifically to nerves.
...
(ref:parasymp) [Innvervations of the parasympathetic nervous system.](https://commons.wikimedia.org/wiki/File:1503_Connections_of_the_Parasympathetic_Nervous_System.jpg)
 

```{r psns, fig.cap='(ref:parasymp)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/pns/1503_Connections_of_the_Parasympathetic_Nervous_System.jpg")
```
