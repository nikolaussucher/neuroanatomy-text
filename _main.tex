...
\hypersetup{
  pdftitle={Text For BIO400 Neuroanatomy at Salem State University},
...
\title{Text For BIO400 Neuroanatomy at Salem State University}
...
\begin{center}\includegraphics[width=0.7\linewidth]{neuroanatomy_text_dark_cover} \end{center}
...
This text was assembled using various pages from \href{https://www.wikipedia.org}{Wikipedia} as my source. I copied text passages from many Wikipedia pages, remixed, edited, adapted and suplemented it with my own words to assemble the chapters of this text. I make this text available as an open educational resource under \href{https://creativecommons.org/licenses/by-sa/3.0/deed.en}{Creative Commons Attribution-Share Alike 3.0 Unported} United States License (\href{https://en.wikipedia.org/wiki/Wikipedia:Text_of_Creative_Commons_Attribution-ShareAlike_3.0_Unported_License}{same} as Wikipedia) for others to do as I did and freely copy, remix, edit and adapt as required. Illustrations with associated hyperlinks are from Wikimedia Commons, which should be consulted for copyright details. Pictures and illustrations that I generated myself are subject to the \href{https://creativecommons.org/licenses/by-sa/3.0/deed.en}{Creative Commons Attribution-Share Alike 3.0 Unported} United States License. I want to thank all the contributors and supporters of Wikipedia for making it possible and keeping it relevant. I am grateful for the support provided by the Salem State University's OER initiative.
...
\midrule
\cellcolor{gray!6}{α} & \cellcolor{gray!6}{Aα} & \cellcolor{gray!6}{13-20} & \cellcolor{gray!6}{Yes} & \cellcolor{gray!6}{80–120} & \cellcolor{gray!6}{Extrafusal muscle fibers}\\
β & Aβ &  &  &  & \\
\cellcolor{gray!6}{γ} & \cellcolor{gray!6}{Aγ} & \cellcolor{gray!6}{5-8} & \cellcolor{gray!6}{Yes} & \cellcolor{gray!6}{4–24} & \cellcolor{gray!6}{Intrafusal muscle fibers}\\
\bottomrule
\end{longtable}
...
\midrule
\cellcolor{gray!6}{Ia} & \cellcolor{gray!6}{Aα} & \cellcolor{gray!6}{13-20} & \cellcolor{gray!6}{Yes} & \cellcolor{gray!6}{80–120} & \cellcolor{gray!6}{Primary receptors of muscle spindle (annulospiral ending)} & \cellcolor{gray!6}{Proprioceptors}\\
Ib & Aα & 13-20 & Yes & 80–120 & Golgi tendon organ & Proprioceptors\\
\cellcolor{gray!6}{II} & \cellcolor{gray!6}{Aβ} & \cellcolor{gray!6}{6-12} & \cellcolor{gray!6}{Yes} & \cellcolor{gray!6}{33–75} & \cellcolor{gray!6}{Secondary receptors of muscle spindle (flower-spray ending). All cutaneous mechanoreceptors} & \cellcolor{gray!6}{Proprioceptors; mechanoceptors}\\
...
\cellcolor{gray!6}{IV} & \cellcolor{gray!6}{C} & \cellcolor{gray!6}{0.2-1.5} & \cellcolor{gray!6}{No} & \cellcolor{gray!6}{0.5-2.0} & \cellcolor{gray!6}{Nociceptors of anterior spinothalamic tract; warmth receptors} & \cellcolor{gray!6}{Nociceptors and thermoreceptors}\\
\bottomrule
\end{longtable}
...
\cmidrule{1-3}\pagebreak[0]
\cellcolor{gray!6}{CNS} & \cellcolor{gray!6}{Astrocytes} & \cellcolor{gray!6}{In general, there are two types of astrocytes, protoplasmic and fibrous, similar in function but distinct in morphology and distribution. Protoplasmic astrocytes have short, thick, highly branched processes and are typically found in gray matter. Fibrous astrocytes have long, thin, less branched processes and are more commonly found in white matter.}\\
\cmidrule{1-3}\pagebreak[0]
...
{\centering \includegraphics[width=0.7\linewidth]{./figures/pns/Nervous_system_diagram-en} 

}

\caption{\href{https://commons.wikimedia.org/wiki/File:Nervous_system_diagram-en.svg}{Diagram of the the human peripheral nervous system (blue) and central nervous system (yellow).}}\label{fig:pnscns}
\end{figure}
...
\caption{View of the base of the brain. The cranial nerves are colored in purple and labeled with numbers on the left (1 to 12). From \href{https://archive.org/details/anatomyofhumanbo1918gray/page/n6/mode/2up}{Gray Henry, Anatomy of the Human Body. 20\textsuperscript{th} Edition, Lea \& Febiger, Philadelphia \& New York, 1918}}\label{fig:baseofbrain}
\end{figure}
...
\midrule
\cellcolor{gray!6}{Digestive system} & \cellcolor{gray!6}{Increase peristalsis and amount of secretion by digestive glands} & \cellcolor{gray!6}{Decrease activity of digestive system}\\
Liver & No effect & Causes glucose to be release to blood\\
\cellcolor{gray!6}{Lungs} & \cellcolor{gray!6}{Constricts bronchioles} & \cellcolor{gray!6}{Dilates bronchioles}\\
Urinary bladder/ Urethra & Relaxes sphincter & Constricts sphincter\\
\cellcolor{gray!6}{Kidneys} & \cellcolor{gray!6}{No effects} & \cellcolor{gray!6}{Decrease urine output}\\
\addlinespace
Heart & Decreases rate & Increase rate\\
\cellcolor{gray!6}{Blood vessels} & \cellcolor{gray!6}{No effect on most blood vessels} & \cellcolor{gray!6}{Constricts blood vessels in viscera; increase BP}\\
...
\cellcolor{gray!6}{Eye (iris)} & \cellcolor{gray!6}{Stimulates constrictor muscles; constrict pupils} & \cellcolor{gray!6}{Stimulate dilator muscle; dilates pupils}\\
...
\addlinespace
\cellcolor{gray!6}{Adrenal Medulla} & \cellcolor{gray!6}{No effect} & \cellcolor{gray!6}{Stimulate medulla cells to secrete epinephrine and norepinephrine}\\
...
{\centering \includegraphics[width=0.7\linewidth]{./figures/pns/1501_Connections_of_the_Sympathetic_Nervous_System} 

}

\caption{\href{https://commons.wikimedia.org/wiki/File:1501_Connections_of_the_Sympathetic_Nervous_System.jpg}{Innvervations of the sympathetic nervous system.}}\label{fig:sns}
\end{figure}
...
{\centering \includegraphics[width=0.7\linewidth]{./figures/pns/1503_Connections_of_the_Parasympathetic_Nervous_System} 

}

\caption{\href{https://commons.wikimedia.org/wiki/File:1503_Connections_of_the_Parasympathetic_Nervous_System.jpg}{Innvervations of the parasympathetic nervous system.}}\label{fig:psns}
\end{figure}
...
{\centering \includegraphics[width=0.7\linewidth]{./figures/motor/1022_Muscle_Fibers_(small)} 

}

\caption{\href{https://upload.wikimedia.org/wikipedia/commons/9/9c/1022_Muscle_Fibers_\%28small\%29.jpg}{Structure of the skeletal muscle fiber.}}\label{fig:muscle}
\end{figure}
...
{\centering \includegraphics[width=0.7\linewidth]{./figures/motor/1009_Motor_End_Plate_and_Innervation} 

}

\caption{\href{https://commons.wikimedia.org/wiki/File:1009_Motor_End_Plate_and_Innervation.jpg}{Structure of neuromuscular junction.}}\label{fig:neuromuscularjunction}
\end{figure}
...
\subsection{Sliding filament theory}\label{sliding-filament-theory}}
...
{\centering \includegraphics[width=0.7\linewidth]{./figures/motor/1008_Skeletal_Muscle_Contraction} 

}

\caption{\href{https://commons.wikimedia.org/wiki/File:1008_Skeletal_Muscle_Contraction.jpg}{Crossbridge cycling and the molecular basis of muscle contraction.}}\label{fig:crossbridge}
\end{figure}
...
\chapter{Major Diseases Of The Nervous System}\label{major-diseases-of-the-nervous-system}}

\hypertarget{neurodegenerative-diseases}{%
\section{Neurodegenerative Diseases}\label{neurodegenerative-diseases}}
...
{\centering \includegraphics[width=0.7\linewidth]{./figures/disease/Alzheimers_brain} 

}

\caption{\href{https://commons.wikimedia.org/wiki/File:Alzheimers_brain.jpg}{Comparison of brain tissue between healthy individual and Alzheimer's disease patient, demonstrating extent of neuronal death}}\label{fig:alzheimerbrain}
\end{figure}
...
{\centering \includegraphics[width=0.7\linewidth]{./figures/disease/Histopathology_of_Alzheimer's_disease} 

}

\caption{\href{https://commons.wikimedia.org/wiki/File:Histopathology_of_Alzheimer\%27s_disease.jpg}{Histopathologic images of Alzheimer's disease, in the CA3 area of the hippocampus, showing an amyloid plaque (top right), neurofibrillary tangles (bottom left) and granulovacuolar degeneration (bottom center).}}\label{fig:alzheimer}
\end{figure}

\hypertarget{parkinsons-disease}{%
\subsection{Parkinson's disease}\label{parkinsons-disease}}
...
{\centering \includegraphics[width=0.7\linewidth]{./figures/disease/Lewy_Body_alphaSynuclein} 

}

\caption{\href{https://commons.wikimedia.org/wiki/File:Lewy_Body_alphaSynuclein.jpg}{A Lewy body (stained brown) in a brain cell of the substantia nigra in Parkinson's disease. The brown colour is positive immunohistochemistry staining for alpha-synuclein.}}\label{fig:parkinson}
\end{figure}
...
\subsection{Huntington's disease}\label{huntingtons-disease}}
...
\subsection{Amyotrophic lateral sclerosis (ALS)}\label{amyotrophic-lateral-sclerosis-als}}
...
{\centering \includegraphics[width=0.7\linewidth]{./figures/disease/MCA_Territory_Infarct} 

}

\caption{\href{https://commons.wikimedia.org/wiki/File:MCA_Territory_Infarct.svg}{CT-scan of the brain with an MCA infarct.}}\label{fig:ctstroke}
\end{figure}
...
\hypertarget{aphasia}{%
\subsection{Aphasia}\label{aphasia}}
...
Localizationist approaches aim to classify the aphasias according to their major presenting characteristics and the regions of the brain that most probably gave rise to them. Inspired by the early work of nineteenth-century neurologists \href{}{Paul Broca} and \href{}{Carl Wernicke}, these approaches identify two major subtypes of aphasia and several more minor subtypes:



\begin{figure}

{\centering \includegraphics[width=0.7\linewidth]{./figures/disease/BrocasAreaSmall} 

}

\caption{\href{https://commons.wikimedia.org/wiki/File:BrocasAreaSmall.png}{Cortical areas damaged in Broaca's and Wernicke's aphasia.}}\label{fig:aphasias}
\end{figure}
...
\subsection{Prosopagnosia}\label{prosopagnosia}}
...
\caption{\href{https://commons.wikimedia.org/wiki/File:Spike-waves.png}{The electroencephalogram recording} of a person with childhood absence epilepsy showing a seizure. The waves are black on a white background.}\label{fig:epilepsyeeg}
\end{figure}
...
\subsection{Mood Disorders}\label{mood-disorders}}
...
\midrule
\cellcolor{gray!6}{Anteroposterior} & \cellcolor{gray!6}{Anterior} & \cellcolor{gray!6}{Belly in orthograde bipeds (including humans)}\\
\cmidrule{1-3}\pagebreak[0]
Anteroposterior & Anterior & Head end in fish\\
\cmidrule{1-3}\pagebreak[0]
\cellcolor{gray!6}{Posterior} & \cellcolor{gray!6}{Back in orthograde bipeds} & \cellcolor{gray!6}{}\\
\cmidrule{1-3}\pagebreak[0]
Posterior & Rear/tail end & \\
\cmidrule{1-3}\pagebreak[0]
\cellcolor{gray!6}{Rostrocaudal, craniocaudal, cephalocaudal,  longitudinal} & \cellcolor{gray!6}{Rostral, cranial, cephalad} & \cellcolor{gray!6}{Head end}\\
\cmidrule{1-3}\pagebreak[0]
Caudal & Rear/tail end & \\
\cmidrule{1-3}\pagebreak[0]
\cellcolor{gray!6}{Caudal} & \cellcolor{gray!6}{Inferior in humans} & \cellcolor{gray!6}{}\\
\cmidrule{1-3}\pagebreak[0]
Dorsoventral & Dorsal & Back, spinal column\\
\cmidrule{1-3}\pagebreak[0]
\cellcolor{gray!6}{Ventral} & \cellcolor{gray!6}{Belly} & \cellcolor{gray!6}{}\\
\cmidrule{1-3}\pagebreak[0]
Left-right, dextro-sinister, sinistro-dexter & Left (sinister) & Left-hand side\\
\cmidrule{1-3}\pagebreak[0]
\cellcolor{gray!6}{Right (dexter)} & \cellcolor{gray!6}{Right-hand side} & \cellcolor{gray!6}{}\\
\cmidrule{1-3}\pagebreak[0]
Mediolateral & Medial & Centre\\
\cmidrule{1-3}\pagebreak[0]
\cellcolor{gray!6}{Lateral} & \cellcolor{gray!6}{Left and right} & \cellcolor{gray!6}{}\\
\cmidrule{1-3}\pagebreak[0]
Proximal/distal & Proximal & Point at which appendage joins the body\\
\cmidrule{1-3}\pagebreak[0]
\cellcolor{gray!6}{Distal} & \cellcolor{gray!6}{Extremity of appendage} & \cellcolor{gray!6}{}\\
\bottomrule
\end{longtable}
...
\subsection{Cranial And Caudal}\label{cranial-and-caudal}}
